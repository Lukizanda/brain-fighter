...
- [[systems/Tests]] — in-Studio harness: TestRunner + `TestAutoRunner` (`workspace.RunTests`), 8 suites / 43 tests (NPC, Multiplayer, Phase3, Skills, Hardening, Economy, Unit, Analytics), results in `TestResult_*` attributes; MCP-driven via `/run-tests`
